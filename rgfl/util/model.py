...
from rgfl.util.api_requests import (
    create_anthropic_config,
    create_chatgpt_config,
    request_anthropic_engine,
    request_chatgpt_engine,
)
from rgfl.util.api_requests import request_gemini_engine, create_gemini_config
    ...
    def codegen(
        ...
        for _ in range(num_samples):
            ...
            if ret:
                trajs.append(
                    {
                        "response": ret.text,  # Clean and direct access to output
                        "usage": {
                            "completion_tokens": 0,  # Gemini Vertex doesn't return these yet
                            "prompt_tokens": 0,
                        },
                    }
                )
